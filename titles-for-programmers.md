...
We use the following criteria to assess the level and title of programmers of BlackHyve. These criteria aren’t exhaustive, and they aren’t mere checklists. They’re guidelines to having an individualized discussion about career progression.
...
* Can set and direct an entire department, like SIP, or Core Product.
* Fully capable of designing, owning, and running entirely new, novel systems (a new billing system for example)
